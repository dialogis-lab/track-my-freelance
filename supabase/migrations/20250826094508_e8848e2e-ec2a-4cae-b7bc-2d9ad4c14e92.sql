...
-- Add additional security constraint to prevent null user_id (should already exist but ensure it)
-- Note: user_id is already NOT NULL based on the schema, but this adds extra validation
ALTER TABLE public.clients 
ADD CONSTRAINT IF NOT EXISTS clients_user_id_not_null 
